...
export default function DashboardPage() {
  // TODO: Fetch user's weddings from Supabase after auth is connected
  return (
    <main>
      <Navbar />
      ...
      <section className="pt-28 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/templates"
              className="bg-[#1a1a2e] text-[#faf8f4] px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-[#2a2a3e] transition-colors"
            >
              + Нове весілля
            </Link>
          </div>
          ...
          <div className="mt-16 text-center py-20 border border-dashed border-[#e8e0d4] rounded-2xl">
            ...
            <Link
              href="/templates"
              className="inline-block mt-6 bg-[#b8956a] text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-[#a07850] transition-colors"
            >
              Обрати шаблон
            </Link>
          </div>
