  ...
  return (
    <main>
          ...
          <div className="space-y-12">
            {[
              ...
              <div key={s.n} className="flex gap-6 items-start">
                ...
                <div>
                  <h3 className="font-serif text-xl text-[#1a1a2e] mb-1">{s.title}</h3>
      ...
      <section className="py-24 px-6 bg-[#1a1a2e] text-center">
        ...
        <p className="text-sm text-gray-400 mb-8 max-w-md mx-auto">Безкоштовний шаблон. Без підписки. UA / EN / RO.</p>
        <Link href="/templates" className="inline-block bg-[#b8956a] text-[#faf8f4] px-8 py-3.5 rounded-lg font-medium text-sm hover:bg-[#a07850] transition-colors">
          Почати безкоштовно
        </Link>
      </section>
